...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Bow_Pressure", &fHslider1, FAUSTFLOAT(0.3f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	FAUST_ADDHORIZONTALSLIDER("Physical_and_Nonlinearity/Physical_Parameters/Bow_Pressure", fHslider1, 0.3f, 0.0f, 1.0f, 0.01f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, Bow_Pressure, "Physical_and_Nonlinearity/Physical_Parameters/Bow_Pressure", fHslider1, 0.3f, 0.0f, 1.0f, 0.01f) \
