...
Exécutez ensuite HarpeDeVerre.py. Avant, il faut télécharger ces deux librairies python:
pip install pyserial
pip install pynput 

Lorsque la teensy détectera une note elle sera afficher dans le terminal. Si vous appuyez sur le bouton de la breadboard, vous pourrez jouez des notes avec le clavier. 
...
La plaque arduino dispose d'un potentiomètre, qui sert à régler le son en sortie, et d'un bouton, qui sert à passer d'un mode d'écoute à l'autre. On peut en effet choisir d'écouter la reproduction en harpe de verre ou bien de jouer nous même avec le clavier de la harpe de verre.
