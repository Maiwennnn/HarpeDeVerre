...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = 1.0f / std::max<float>(1.0f, 0.4f * fConst0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Bow_Pressure", &fHslider1, FAUSTFLOAT(0.65f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = 6.0f * (float(fHslider0) + 2.5f);
	...
	FAUST_ADDHORIZONTALSLIDER("Physical_and_Nonlinearity/Physical_Parameters/Bow_Pressure", fHslider1, 0.65f, 0.0f, 1.0f, 0.01f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, Bow_Pressure, "Physical_and_Nonlinearity/Physical_Parameters/Bow_Pressure", fHslider1, 0.65f, 0.0f, 1.0f, 0.01f) \
...
glassHarp::glassHarp() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void glassHarp::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void glassHarp::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float glassHarp::getParamValue(const std::string& path)
{
